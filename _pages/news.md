...
The 2024 IEEE/IFIP Network Operations and Management Symposium (NOMS 2024) was held from May 6 to May 10, 2024, at The-K Hotel in Seoul, South Korea. This symposium, returning to Korea after two decades, was a significant gathering for professionals in the field of network operations and management. NOMS 2024 featured a comprehensive program, including keynotes, technical sessions, panel discussions, and various workshops, all centered around the theme “Towards intelligent, reliable, and sustainable network and service management.” The symposium highlighted the latest advancements in 5G and emerging 6G networks, focusing on their roles in supporting critical applications like IoT, smart cities, and autonomous vehicles. Attendees included researchers, developers, service providers, and policymakers, making NOMS 2024 an invaluable platform for knowledge exchange and collaboration in shaping the future of network management【5†source】.
...
**Authors: Carlos Melo, Glauber Gonçalves, Francisco A. Silva, Leonel Feitosa, Iure Fé, André Soares, Eunmi Choi, Tuan Anh Nguyen, and Dugki Min**

**Research Context:**
Hyperledger Fabric, a prominent framework for permissioned blockchain systems, offers robust data security and auditability essential for enterprise applications. With the increasing adoption of blockchain technology across various sectors, understanding the performance implications of different configuration parameters in Hyperledger Fabric is crucial. This research is situated within the broader context of improving blockchain performance and efficiency, focusing on the computational and transactional dynamics that affect system performance.

**Research Contributions and Novelty:**
The primary contribution of this research is the development of a Stochastic Petri Net (SPN) model tailored to evaluate the performance of Hyperledger Fabric under various configurations. This model addresses the gaps in existing performance models by incorporating detailed analyses of the endorsement, ordering, and commit phases of transactions. The novelty lies in its ability to provide administrators with actionable insights into optimizing blockchain configurations to enhance operational efficiency before deployment. Additionally, the research includes practical case studies and a sensitivity analysis that identify critical factors affecting mean response time (MRT), offering a comprehensive understanding of the system's performance under different scenarios.

**Research Findings and Implications:**
The findings from the SPN model highlight the significant impact of block size and transaction arrival rates on system response times, with variations leading to mean response times ranging from 1 to 25 seconds. The case studies validated the model's utility in real-world applications, demonstrating its effectiveness in optimizing resource utilization and transaction throughput. The implications of this research are substantial for blockchain administrators and developers, providing a robust framework for pre-deployment performance evaluation and capacity planning in Hyperledger Fabric. This work paves the way for more efficient and scalable blockchain implementations, particularly in enterprise environments where performance and cost are critical considerations.

In conclusion, this paper presented at NOMS 2024 offers significant advancements in the performance evaluation of Hyperledger Fabric, providing a valuable tool for enhancing blockchain system configurations and ultimately contributing to more efficient and reliable blockchain deployments in various industrial sectors【4†source】【5†source】.
