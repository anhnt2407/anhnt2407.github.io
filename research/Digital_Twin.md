...
excerpt: "Digital twin engines and cloud-backed infrastructure for urban air mobility, including dynamics engines, control engines, teleoperation frames, and scalable twin backends."
permalink: /research/Digital_Twin
author_profile: true
---

<div class="page-lead">
  <p>This research direction develops the core engines and infrastructure required to build operational digital twins for urban air mobility vehicles. The work spans dynamics modeling, control design, teleoperation interfaces, and cloud-backed twin platforms that keep physical and digital vehicles tightly aligned.</p>
</div>
...
This research proposes and discusses an overall engineering direction for the development of UAM vehicle digital twin systems. Preliminary results show that these approaches can clone the dynamics and control behavior of UAM vehicles for the development of UAM-ODT.
